...
Source0  : https://files.pythonhosted.org/packages/b9/bb/7a283f568af6b0528ade65e8ace84bd6ba46003e429101bcd62c232d01a5/git_filter_repo-2.47.0.tar.gz
...
%prep
%setup -q -n git_filter_repo-2.47.0
cd %{_builddir}/git_filter_repo-2.47.0
pushd ..
cp -a git_filter_repo-2.47.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1733311205
...
cp %{_builddir}/git_filter_repo-%{version}/COPYING.mit %{buildroot}/usr/share/package-licenses/pypi-git_filter_repo/1128f1780ffaed48621666c25be7736045490170 || :
...
/usr/share/package-licenses/pypi-git_filter_repo/1128f1780ffaed48621666c25be7736045490170
